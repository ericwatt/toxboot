...
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/ericwatt/toxboot?branch=master&svg=true)](https://ci.appveyor.com/project/ericwatt/toxboot)
[![Coverage Status](https://img.shields.io/codecov/c/github/ericwatt/toxboot/master.svg)](https://codecov.io/github/ericwatt/toxboot?branch=master)
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/toxboot)](https://cran.r-project.org/package=toxboot)
[![DOI](https://zenodo.org/badge/18526/ericwatt/toxboot.svg)](https://zenodo.org/badge/latestdoi/18526/ericwatt/toxboot)
...
This package uses `mongolite` as the package to communicate with a Mongo database. 
