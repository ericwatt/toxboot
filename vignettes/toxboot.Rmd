...
Under the hood, this function does some filtering of m4ids if writing to mongoDB and then runs the function `toxboot` using mclapply so that the bootstrapping will be multicore.
...
Comparisons like this plot allow the optimum number of bootstrap resamples to be selected. 
